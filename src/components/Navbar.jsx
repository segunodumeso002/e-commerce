    ...
    <nav className="sticky top-0 z-50 bg-gradient-to-r from-blue-700 via-pink-500 to-yellow-400 text-white shadow-lg">
      <div className="container mx-auto flex justify-between items-center py-4 px-2">
        ...
        >
          ...
          <Link to="/orders" className="modern-btn hover:scale-105 transition-transform duration-200 text-indigo-600">My Orders</Link>
          {user?.is_admin && (
            <Link to="/admin" className="modern-btn font-bold hover:scale-105 transition-transform duration-200 text-indigo-600">Admin Dashboard</Link>
          )}
          {user ? (
            <>
              <Link to="/profile" className="modern-btn hover:scale-105 transition-transform duration-200 text-indigo-600">Profile</Link>
            ...
            <>
              <Link to="/login" className="modern-btn hover:scale-105 transition-transform duration-200 text-indigo-600">Login</Link>
              <Link to="/register" className="modern-btn hover:scale-105 transition-transform duration-200 text-indigo-600">Register</Link>
            </>
          )}
          <Link to="/contact" className="modern-btn hover:scale-105 transition-transform duration-200 text-indigo-600">Contact Us</Link>
        </div>
      </div>
    </nav>
  );
